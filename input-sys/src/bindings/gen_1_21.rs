...
fn bindgen_test_layout_libinput_interface() {
    const UNINIT: ::std::mem::MaybeUninit<libinput_interface> = ::std::mem::MaybeUninit::uninit();
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).open_restricted) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).close_restricted) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(libinput_interface),
...
pub type libinput_config_dwtp_state = ::libc::c_uint;
extern "C" {
    ...
    pub fn libinput_device_config_dwtp_is_available(device: *mut libinput_device) -> ::libc::c_int;
}
extern "C" {
